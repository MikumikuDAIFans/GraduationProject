# AI Assistant Browser Full Acceptance 20260515182307

- API: http://127.0.0.1:18741/api
- Web: http://127.0.0.1:8894
- DB: E:\GraduationProject\backend\data\browser_full_acceptance_20260515182307.db
- Memory: E:\GraduationProject\backend\data\browser_full_acceptance_memory_20260515182307
...
| BAI-P1-014 | PASS | 同句包含多个日程目标 | events=0, tasks=0, proposals=2, memories=0 |
...
| BAI-P0-106 | PASS | 无确认不写长期记忆 | events=0, tasks=0, proposals=2, memories=0 |
...
| BAI-P0-105 | PASS | 补充回答不当成全新任务 | proposals=1 |
...
| BAI-P1-404 | PASS | 移动端布局 | screenshot=E:\GraduationProject\docs\development\browser_acceptance_runs\mobile_20260515182307.png |
