...
class AssistantService(Protocol):
    ...
    async def create_session(self, user_id: str, payload: AssistantSessionCreate) -> AssistantSessionRead | dict[str, Any]: ...
    async def list_sessions(self, user_id: str, limit: int = 20) -> AssistantSessionListRead | dict[str, Any]: ...
