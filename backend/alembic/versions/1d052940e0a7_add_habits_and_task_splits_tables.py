...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('time_pattern', sa.String(length=50), nullable=True),
        sa.Column('day_pattern', sa.String(length=50), nullable=True),
        ...
        sa.ForeignKeyConstraint(['user_id'], ['user_profile.username'], ondelete='CASCADE'),
    ...
    op.add_column('events', sa.Column('habit_id', sa.String(length=36), nullable=True))
    with op.batch_alter_table('events') as batch_op:
        batch_op.create_foreign_key('fk_events_habit_id', 'habits', ['habit_id'], ['id'])

    op.add_column('tasks', sa.Column('max_splits', sa.Integer(), nullable=False, server_default='1'))
    op.add_column('tasks', sa.Column('min_chunk_minutes', sa.Integer(), nullable=False, server_default='15'))
    op.add_column('tasks', sa.Column('split_strategy', sa.String(length=50), nullable=True))
